...
xlabel!(p, L"x")
ylabel!(p, L"y")
plot!(p, naivediscritezationDict[initialTimeStep], c=palette[6], alpha=0.7, annotations=(2.3, -2.2, L"\Omega_{\left[0, \delta_1 \right]}"))
plot!(p, discritezationDict[initialTimeStep], c=palette[9], alpha=1.0, annotations=(-0.1, 0.3, L"\Omega_{\left[0, \delta_1 \right]}"))
...
plot!(p, naivediscritezationDict[initialTimeStep], c=palette[6], alpha=0.7, annotations=(2., -2.1, L"\Omega_{[0, \delta_1]}"))
plot!(p, discritezationDict[initialTimeStep], c=palette[9], alpha=1.0, annotations=(0.1, 0.6, L"\Omega_{[0, \delta_1]}"))
